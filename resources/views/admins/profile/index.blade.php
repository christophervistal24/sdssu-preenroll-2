                ...
                <div class="card card-small mb-4 pt-3 rounded-0">
                  <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto">
                      <img class="rounded-circle" src="{{url("storage/profile/$user_info->profile") }}" alt="User Avatar" width="110">
                       ...
                       <div>
                    <form action="/admin/{{$user_info->id_number}}/changeprofile" method="POST" enctype="multipart/form-data">
                        @csrf
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-4">
                      <span>
                        <form action="/admin/profile/{{$user_info->id_number}}" method="POST">
                          @csrf
                ...
                <div class="card card-small mb-4">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form method="POST" action="/admin/profile/{{$user_info->id_number}}">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                              <div class="form-group col-md-12">
