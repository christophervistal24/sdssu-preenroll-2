                            ...
                            <tbody>
                                @foreach ($student_preenroll as $student)
                                    <tr>
                                     ...
                                     <th class="text-center">{{\Carbon\Carbon::parse( $student->created_at)->format('jS \o\f F, Y g:i A') }}</th>
                                        <td class="text-center"><a href="/admin/accept/preenroll/{{ $student->student_id }}" class="btn btn-primary rounded-0"><b>View</b></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
