                  ...
                  <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto">
                      <img class="rounded-circle" src="{{url("storage/profile/$user_info->profile") }}" alt="User Avatar" width="110">
                       ...
                       <div>
                       <form action="/instructor/{{$user_info->id_number}}/changeprofile" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <span class="text-muted d-block mb-2">Instructor</span>
                  </div>
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-4">
                      <span>
                        <form action="/instructor/profile/{{$user_info->id_number}}" method="POST">
                          @csrf
                ...
                <div class="card card-small mb-4">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form method="POST" action="/instructor/profile/{{$user_info->id_number}}">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                              <div class="form-group col-md-12">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                ...
                                <select name="status" id="feInputCity" class="form-control font-weight-bold">
                                  <option value="active" {{($user_info->active  == 'Active') ? 'selected' : null }}>Active</option>
                                  <option value="in-active" {{($user_info->active  == 'In-active') ? 'selected' : null }}>In-active</option>
                                </select>
                              </div>
                            </div>
