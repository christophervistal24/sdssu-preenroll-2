...
class ImportStudentHelper {
    ...
    {
        $this->db->exec( //insert new students to table students
            sprintf("
                LOAD DATA local INFILE '%s' replace INTO TABLE students
                FIELDS TERMINATED BY ','
                LINES TERMINATED BY '\n' IGNORE 1 LINES
                (id_number,fullname,address,gender,year,@course_id,block,mobile_number,mothername,fathername,parent_mobile_number)
