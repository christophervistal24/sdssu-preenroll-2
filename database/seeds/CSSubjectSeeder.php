    ...
    public function run()
    {
         DB::table('subjects')->insert([
         	...
         	[
					...
					'units'           => 3,
					'year'            => 1,
					'course' => Course::where('course_code','CS')->first()->id,
					'semester'        => 1,
         	],
         	[
					'sub'             => 'CS 112',
         	...
         	[
					'sub'             => 'CE 121',
					'sub_description' => 'Engineering 10',
					'units'           => 3,
					'year'            => 5,
					'course' => Course::where('course_code','CE')->first()->id,
					'semester'        => 2,
